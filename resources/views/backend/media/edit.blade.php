        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-xl-9">
                        <div class="card">
                            <form action="{{ route('backend.media.update',$id) }}" class="needs-validation" novalidate
                                  method="post"
                                    ...
                                    <div class="tab-content p-3 text-muted">
                                                ...
                                                <div class="form-group row">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="name[{{ $lan->code }}]" type="text"
                                                               class="form-control"
                                                               required=""
                                                               value="{{ $media->translate($lan->code)->name ?? '-' }}">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="description[{{ $lan->code }}]" type="text"
                                                                  ...
                                                                  required="">{!! $media->translate($lan->code)->description ?? '-' !!}</textarea>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if(file_exists($media->photo))
                                                <img src="{{ asset($media->photo) }}" class="mt-3 w-100">
                                            @endif
                                                    ...
                                                    @foreach($media->photos()->get() as $photo)
                                                        <div style="position:relative;" class="wraper  m-3">
                                                            ...
                                                            <a style="position: absolute; right:5px; top:5px"
                                                               ...
                                                               href="{{ route('backend.deletePhoto',['model' => 'Media','id' => $photo->id]) }}">X</a>
                                                        </div>
                                                    @endforeach
                                                </div>
                                            @endif
