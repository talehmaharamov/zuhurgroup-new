                    ...
                    <div class="card-body">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">@lang('backend.packages'):</h4>
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                            ...
                            @foreach($packages as $package)
                                <tr>
                                    <td>{{ $package->id }}</td>
                                    <td>{{ $package->translate(app()->getLocale())->name ?? __('backend.translation-not-found') }}</td>
                                    @include('backend.templates.components.dt-settings',['variable' => 'packages','value' => $package])
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
