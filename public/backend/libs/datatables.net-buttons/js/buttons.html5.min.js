(function (j) {
    ...
    var B = {
        ...
        match: /^[\d]{4}\-[\d]{2}\-[\d]{2}$/, style: 67, fmt: function (a) {
            ...
            var e = this, g = 0, h, a = function (a) {
                ...
                for (var b = 0, d = a.length; b < d; b++) {
                    ...
                    f || ("number" === typeof a[b] || a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/) ? f = n(i, "c", {
                        attr: {t: "n", r: e}, children: [n(i, "v", {text: a[b]})]
                        ...
                        attr: {
                            ...
                            row: n(i, "is", {
                                children: {
                                    row: n(i, "t", {
                                        text: h, attr: {"xml:space": "preserve"}
                                    })
                                }
                            })
                        }
    ...
    q.ext.buttons.pdfHtml5 = {
        ...
        action: function (a, b, d, c) {
            ...
            a.messageTop && d.content.unshift({
                text: a.messageTop, style: "message", margin: [0, 0, 0, 12]
            });
