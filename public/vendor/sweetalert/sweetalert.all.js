!function (e, t) {
    ...
    "use strict";
    const t = "SweetAlert2:", v = e => e.charAt(0).toUpperCase() + e.slice(1), r = e => Array.prototype.slice.call(e),
        a = e => {
        ...
        k = e => C(e) ? e.toPromise() : Promise.resolve(e), A = e => e && Promise.resolve(e) === e, i = {
            title: "",
            titleText: "",
            text: "",
            html: "",
        ...
        B = e => Object.prototype.hasOwnProperty.call(i, e), x = e => -1 !== s.indexOf(e), E = e => c[e], T = e => {
    ...
    const X = {previousBodyPadding: null}, l = (t, e) => {
        ...
        ce = () => !se(V()) && !se(N()) && !se(F()), le = e => !!(e.scrollHeight > e.clientHeight), ue = e => {
            const t = window.getComputedStyle(e);
            var e = parseFloat(t.getPropertyValue("animation-duration") || "0"),
                n = parseFloat(t.getPropertyValue("transition-duration") || "0");
            return 0 < e || 0 < n
        }, de = () => "undefined" == typeof window || "undefined" == typeof document, pe = 100, f = {}, me = () => {
        ...
        fe = () => {
            ...
            const e = g(), t = oe(e, p.input), n = oe(e, p.file), o = e.querySelector(".".concat(p.range, " input")),
                i = e.querySelector(".".concat(p.range, " output")), a = oe(e, p.select),
                r = e.querySelector(".".concat(p.checkbox, " input")), s = oe(e, p.textarea);
            t.oninput = be, n.onchange = be, a.onchange = be, r.onchange = be, s.oninput = be, o.oninput = () => {
                be(), i.value = o.value
            }, o.onchange = () => {
                be(), o.nextSibling.value = o.value
            }
        }, ye = e => "string" == typeof e ? document.querySelector(e) : e, we = e => {
            const t = g();
    ...
    const Te = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], Se = (e, r) => {
        ...
        }, _e = e => '<div class="'.concat(p["icon-content"], '">').concat(e, "</div>"), Ke = (e, t) => {
            const n = I();
        ...
        }, et = ["swal-title", "swal-html", "swal-footer"], tt = e => {
            const n = {};
    ...
    const pt = () => {
        ...
        const o = g(), i = e => Bt[n.input](o, xt(e), n);
        ...
        select: (e, t, i) => {
            ...
            const r = oe(e, p.radio), n = (t.forEach(e => {
                var t = e[0], e = e[1];
    ...
    }, Et = (e, t) => t && t.toString() === e.toString(), Tt = (e, t) => {
    ...
    const Nt = (e, t, n) => {
        ...
        g().focus()
    }, Rt = ["ArrowRight", "ArrowDown"], Ft = ["ArrowLeft", "ArrowUp"], Ut = (e, n, o) => {
